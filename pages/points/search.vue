<template>
  <view class="search-page">
    <view class="search-bar">
      <input class="input" v-model="kw" placeholder="请输入关键字" confirm-type="search" @confirm="doSearch" />
    </view>
...
.grid{padding:0 16px 20px}
.card{background:#121212;border:1px solid #2f2f2f;border-radius:18px;overflow:hidden;margin-bottom:14px}
